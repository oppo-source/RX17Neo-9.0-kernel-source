...
#ifdef VENDOR_EDIT
//Chunyi.Mei@PSW.BSP.FS.F2FS, 2017-10-23, Add for expose some sectors to user in inline data or dentry
...
{
#ifndef VENDOR_EDIT
// Chunyi.Mei@PSW.BSP.FS.F2FS, 2017-9-7, Remove for fstrim
	struct inode *inode = file_inode(filp);
