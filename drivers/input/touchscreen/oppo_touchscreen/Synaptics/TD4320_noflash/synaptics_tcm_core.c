        ...
        unsigned short addr, unsigned char *data, unsigned int length)
{
    ...
    TPD_INFO("ENTER syna_tcm_rmi_read\n");
...
static int syna_get_input_params(struct syna_tcm_hcd *tcm_hcd)
{
    ...
    TPD_INFO("syna_get_input_params\n");
    ...
    TPD_INFO("syna_get_input_params end\n");
...
int syna_set_input_reporting(struct syna_tcm_hcd *tcm_hcd, bool suspend)
{
    ...
    TPD_INFO("syna_set_input_reporting 1\n");
    ...
    TPD_INFO("syna_set_input_reporting 2\n");
...
static int syna_mode_switch(void *chip_data, work_mode mode, bool flag){
    ...
    switch(mode) {
        case MODE_NORMAL:
            TPD_INFO("syna_mode_switch MODE_NORMAL\n");
...
static fw_check_state syna_fw_check(void *chip_data, struct resolution_info *resolution_info, struct panel_info *panel_data)
{
    ...
    if(!tcm_hcd->using_fae){
        wait_for_completion(&tcm_hcd->config_complete);
    }
...
if(0){
    ...
    /*normal test*/
    syna_int_pin_test(buffer, tcm_hcd, syna_testdata);
    ...
    syna_testing_pt11(buffer, tcm_hcd, syna_testdata);

    /*start Doze test*/
    syna_testing_Doze_dynamic_range(buffer, tcm_hcd, syna_testdata, "DozeDynamic");
    syna_testing_Doze_noise(buffer, tcm_hcd, syna_testdata, "DozeNoise");
