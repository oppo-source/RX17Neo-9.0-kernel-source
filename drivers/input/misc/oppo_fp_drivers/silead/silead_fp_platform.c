 ...
 **  oujinrong                2018/10/05                  add for compatibility of silead and goodix
 ***********************************************************************************/
...
/*Qing.Guan@BSP.Fingerprint.Secure, 2018/11/19, add for silead ca exit with releasing the resource and reset the flag*/
